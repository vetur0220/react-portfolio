...
export const Projects = () => {
  ...
  const projectsFirst = [
    {
      title: "Fun市集",
      description: ".Net5| LinQ | StoredProcedure | Redis | JavaScript | Jquery | Vue.js | Rxjs ",
      imgUrl: projImg1_1,
    ...
    {
      title: "形象網站",
      description: ".Net Core 2.2 | Dapper | JavaScript | Jquery | Kendo UI | TinyMce | ContentBuilder",
      imgUrl: projImg1_3,
